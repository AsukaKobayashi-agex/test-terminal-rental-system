                ...
                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0" style="table-layout:fixed;">
                    ...
                    <div name="search_bar">
                        ...
                        <div class="form-group float-left mx-3">
                            <a target="_blank" href="/admin/add_pc" class="btn btn-success btn-icon-split float-right">
                    ...
                    <tbody>@foreach($pc_device_list as $device)
                        <tr class="font-weight-bold">
                            ...
                            <td class="align-middle px-sm-2 px-0">
                                ...
                                <form name="set_form<?=$i?>" id="unset_form<?=$i?>" method="post" action="index_pc/archive">
                                    @csrf
